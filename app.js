...
onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
        ...
        // (Optional) You can also redirect logged-in users 
        // away from index.html to their dashboard here
        } else {
...
async function lockAndDeploy() {
    ...
    const confirmMsg = 
        ...
        `Instructions: Pay to Merchant 628401.\n` +
...
export function closeAuth() { document.getElementById('authModal').classList.add('hidden'); }
